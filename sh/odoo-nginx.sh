...
server {
    ...
    location / {
        ...
        proxy_set_header X-Forwarded-Proto \$scheme;  # use actual scheme (http or https)
    ...
    # IMPORTANT: catch both /websocket and /websocket/ to avoid 301 redirects
    location ^~ /websocket {
        proxy_pass http://${KEY}_longpolling;   # same upstream; it's your gevent/bus port
